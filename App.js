  ...
  render() {
    ...
    return (
      <ScrollView style={{ flex: 1 }}>
        ...
        {menu1 && (
          <>
            ...
            <View style={styles.content}>
              ...
              <View>
                ...
                <TextInput
                  ...
                  style={styles.box}
                  placeholder='Contoh: 10 Oktober 2022'>
                </TextInput>
            ...
            <View style={styles.footer}>
              <Text>Copyright by Lusi Lesmana Tamba 119140072</Text>
            </View>
          </>
        )}
        ...
        {isCari && (
          <Text style={styles.footer}>Copyright by Lusi Lesmana Tamba 119140072</Text>
        )}
